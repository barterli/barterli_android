...
public class Style {
    ...
    public static class Builder {
         ...
         * @return the {@link Builder}.
         */
        public Builder setBackgroundDrawable(
                        final int backgroundDrawableResourceId) {
         ...
         * @return the {@link Builder}.
         */
        public Builder setTextColorValue(final int textColorValue) {
        ...
        public Builder setImageScaleType(
                        final ImageView.ScaleType imageScaleType) {
    ...
    public String toString() {
        return "Style{" + "configuration=" + configuration
                        ...
                        + ", gravity=" + gravity + ", imageDrawable="
                        + imageDrawable + ", imageResId=" + imageResId
                        + ", imageScaleType=" + imageScaleType + ", textSize="
                        + textSize + ", textShadowColorResId="
