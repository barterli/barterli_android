...
final class Manager extends Handler {
     ...
     */
    private void sendMessageDelayed(final Crouton crouton, final int messageId,
                    final long delay) {
        final Message message = obtainMessage(messageId);
        message.obj = crouton;
    ...
    private void addCroutonToView(final Crouton crouton) {
        ...
        final ViewTreeObserver observer = croutonView.getViewTreeObserver();
        if (null != observer) {
            observer.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
                ...
                public void onGlobalLayout() {
                    ...
                    if (Configuration.DURATION_INFINITE != crouton
                        ...
                        sendMessageDelayed(crouton, Messages.REMOVE_CROUTON, crouton
                                        .getConfiguration().durationInMilliseconds
    ...
    private void handleTranslucentActionBar(
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            if ((flags & translucentStatusFlag) == translucentStatusFlag) {
                final int actionBarContainerId = Resources
                                .getSystem()
    ...
    private void removeCroutonFromViewParent(final Crouton crouton) {
        if (crouton.isShowing()) {
            final ViewGroup parent = (ViewGroup) crouton.getView().getParent();
            if (null != parent) {
