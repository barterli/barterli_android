 ...
 */
public class BlMultiPartRequestTemp extends MultiPartRequest<ResponseInfo> {
     ...
     */
    public BlMultiPartRequestTemp(final int method, final int requestId, final String url, final String requestBody, final Listener<ResponseInfo> listener, final ErrorListener errorListener) {
