...
public interface DialogKeys {
    ...
    /** Key identifying the contentId when the dialog is being created. */
    public static final String CONTENT_ID        = "content_id";

    /** Key identifying the duration to dismiss the dialog in */
    public static final String DISMISS_DURATION  = "dismiss_duration";
